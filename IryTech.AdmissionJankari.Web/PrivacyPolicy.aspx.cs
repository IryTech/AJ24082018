...
namespace IryTech.AdmissionJankari.Web
{
    public partial class PrivacyPolicy : PageBase
    {
        ...
        {
            var objPage = new Common().GetPageTitleKeyWordAndDecsription("PrivacyPolicy");
            ...
            catch (Exception ex)
            {
                ...
                const string addInfo = "Error While fetching BindPageTitleAndKeyWords in PrivacyPolicy.aspx :: -> ";
