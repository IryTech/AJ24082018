<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentOptions.aspx.cs"
     Inherits="IryTech.AdmissionJankari.Web.counselling.PaymentOptions" %>

<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="cphBody">
    <div style="width: 942px; margin: 5px auto; display: block; height: 50px;">
        <img src="/image.axd?Common=feePayment.jpg" /></div>
    <asp:UpdatePanel ID="updateState" runat="server">
        <ContentTemplate>
            <div class="boxPlane mainBG">
                <h3>
                    Pay now to confirm your participation :
                </h3>
                <hr class="hrline" />
                <strong class="fleft">Payment Options:</strong>
                <asp:RadioButtonList ID="rbtnPaymentType" runat="server" AutoPostBack="true" RepeatDirection="Horizontal"
                    OnSelectedIndexChanged="rbtnPaymentType_SelectedIndexChanged">
                ...
                <fieldset id="PaymentOnline">
                    ...
                    <ul class="horizontal CreditCard">
                        <li>
                            ...
                            <asp:RequiredFieldValidator ID="rfvAddress" ValidationGroup="VldgOnlinePayment" SetFocusOnError="true"
                                runat="server" ControlToValidate="txtAddress" CssClass="error" Display="Dynamic">Address  cannot  be blank
                            </asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revAddress" ValidationGroup="VldgOnlinePayment"
                                SetFocusOnError="true" runat="server" CssClass="error" ControlToValidate="txtAddress"
                                Display="Dynamic">
              Special Character not allowed in Address
                        ...
                        <li>
                            ...
                            <asp:RequiredFieldValidator ID="rfvPincode" ValidationGroup="VldgOnlinePayment" SetFocusOnError="true"
                                runat="server" ControlToValidate="txtPincode" CssClass="error" Display="Dynamic">Pin Code cannot  be blank
                            </asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revPincode" ValidationGroup="VldgOnlinePayment"
                                SetFocusOnError="true" runat="server" ControlToValidate="txtPincode" CssClass="error"
                                Display="Dynamic">Pin Code not in correct format(e.g. 201221)
                            </asp:RegularExpressionValidator>
                        </li>
                        <li>
                            <label>
                                Enter State</label>
                            <asp:TextBox ID="txtState" ToolTip="Enter State" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvState" ValidationGroup="VldgOnlinePayment" SetFocusOnError="true"
                                runat="server" ControlToValidate="txtState" CssClass="error" Display="Dynamic">State Name cannot  be blank
                            </asp:RequiredFieldValidator>
                        </li>
                        <li>
                            <label>
                            ...
                            <asp:RequiredFieldValidator ID="rfvCity" ValidationGroup="VldgOnlinePayment" SetFocusOnError="true"
                                runat="server" ControlToValidate="txtCity" CssClass="error" Display="Dynamic">City Name cannot  be blank
                            </asp:RequiredFieldValidator>
                        </li>
                    </ul>
                </fieldset>
                <fieldset id="CashPayment">
                    ...
                    <ol class="horizontal">
                        ...
                        <li><b>Account Name: Admissionjankari.com</b><br />
                            ...
                            <br />
                            <b>RTGS/IFSC/NEFT Code: HDFC0000003 </b><br /><b>Branch:Kasturba Gandhi Marg,New Delhi
                            </b></li>
                        <li>Mention your Reference id(Application form number), Name, Phone No and Email id
                            at the back of the pay-in-slip.</li>
                        <li>To confirm the payment, please send your pay-in-slip at the following address (Via
                            Speed/Registered Post): </li>
                ...
                <fieldset id="DDpayment">
                    ...
                    <ol>
                        <li><b>Make a single Demand Draft</b> (DD) of Rs.
                            ...
                            in favor of <b>"Admissionjankari.com"</b> Payable at <b>"New Delhi"</b> </li>
                        <li>Mention your Reference id(Application form number), Name, Phone No and Email id
                            at the back of the Demand Draft.</li>
                ...
                <fieldset id="chequePayemnt">
                    ...
                    <ol>
                        <li>Please make an account payee cheque of Rs.
                            ...
                            in favor of <b>"Admissionjankari.com"</b> </li>
                ...
                <center>
                    <asp:Button ID="btnFinish" CssClass="button" runat="server" OnClick="Finsh" Text="Finish" /></center>
