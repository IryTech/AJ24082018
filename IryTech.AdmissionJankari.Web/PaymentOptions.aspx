<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="PaymentOptions.aspx.cs" Inherits="IryTech.AdmissionJankari.Web.PaymentOptions" %>
        ...
        <ContentTemplate>
            <div class="boxPlane mainBG">
                ...
                <asp:RadioButtonList ID="rbtnPaymentType" runat="server" AutoPostBack="true" 
                    RepeatDirection="Horizontal" onselectedindexchanged="rbtnPaymentType_SelectedIndexChanged"
                   >
            ...
            <ul class="horizontal CreditCard" >
                <li>
                    ...
                    <asp:RegularExpressionValidator ID="revAddress" ValidationGroup="VldgOnlinePayment"
                        SetFocusOnError="true" runat="server" CssClass="error" ControlToValidate="txtAddress" Display="Dynamic">Special Character not allowed in Address
                    </asp:RegularExpressionValidator>
                </li>
                <li>
                    <label>
                        Pin Code</label>
                    <asp:TextBox ID="txtPincode" ToolTip="Enter the Pincode" width="247px" runat="server"></asp:TextBox>
                    ...
                    <asp:RegularExpressionValidator ID="revPincode" ValidationGroup="VldgOnlinePayment"
                        SetFocusOnError="true" runat="server" CssClass="error" ControlToValidate="txtPincode" Display="Dynamic">Pin Code not in correct format(e.g. 201221)
                    </asp:RegularExpressionValidator>
                </li>
                <li>
                    <label>
                        Enter State</label>
                    <asp:TextBox ID="txtState" runat="server" width="247px" ToolTip="Enter State"></asp:TextBox>
                ...
                <li>
                    <label>
                        Enter City</label>
                   <asp:TextBox ID="txtCity" runat="server" width="247px" ToolTip="Enter City"></asp:TextBox>
            ...
            <fieldset id="CashPayment">
                ...
                <ol class="horizontal">
                    <li>You will need to deposit Rs.
                         26100 in the nearest HDFC BANK in the following account. </li>
                     <li><b>Account Name: Admissionjankari.com</b><br />
                        <b>Account No: 00032 0000 44418</b>  <br />
                   ...
                   <li class="addressStyle">Admissionjankari.com<br />
                        ...
                        New Delhi-110001.<br />
                        Contact us : +91-11-43391978, +91-8800567733</li>
                </ol>
            </fieldset>
            <fieldset id="DDpayment">
                ...
                <ol>
                    <li><b>Make a single Demand Draft</b> (DD) of Rs.
                        26100 in favor of <b>"Admissionjankari.com"</b> payable at <b>"New Delhi"</b>
                        </li>
            ...
            <fieldset id="chequePayemnt">
                ...
                <ol>
                    <li>Please make an account payee cheque of Rs.
                        26100
                        in favor of <b>"Admissionjankari.com"</b> payable at <b>"New Delhi"</b>
                    </li>
                    <li>Mention your Reference Id, Name, Phone No and Email id at the back of the cheque.
                    </li>
                 ...
                 <center> <asp:Button ID="btnFinish" CssClass="button" runat="server" OnClick="Finsh"  Text="Finish" /></center>
