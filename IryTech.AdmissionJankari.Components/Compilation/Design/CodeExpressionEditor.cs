...
namespace IryTech.AdmissionJankari.Components.Compilation.Design
{
    /// <summary>
    /// Code Expression Editor
    /// </summary>
    public class CodeExpressionEditor : ExpressionEditor
    {
        ...
        {
            return string.Concat("[Code:", expression, "]");
        }
