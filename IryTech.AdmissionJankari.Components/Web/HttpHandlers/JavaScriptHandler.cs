...
namespace IryTech.AdmissionJankari.Components.Web.HttpHandlers
{
    ...
    public class JavaScriptHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            bool minify = ((request.QueryString["minify"] != null) || (ApplicationSettings.Instance.CompressWebResource && (cacheKey.Contains("WebResource.axd") || cacheKey.Contains("ScriptResource.axd"))));
        ...
        {
            var lookfor = ConfigurationManager.AppSettings.Get("Apps.HardMinify").Split(
        ...
        private static string RetrieveLocalScript(string file, string cacheKey, bool minify)
        {
            ...
            try
            {
                ...
                if (File.Exists(path))
                {
                    ...
                    Applications.CurrentInstance.Cache.Insert(cacheKey, script, new CacheDependency(path));
                    return script;
                }
            }
            catch (Exception ex)
