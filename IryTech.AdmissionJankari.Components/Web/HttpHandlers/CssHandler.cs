...
namespace IryTech.AdmissionJankari.Components.Web.HttpHandlers
{
    ...
    public class CssHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var fileName = (string)request.QueryString["name"];
            ...
            if (!string.IsNullOrEmpty(fileName))
            {
                ...
                var cacheKey = request.RawUrl.Trim();
                var css = (string)Applications.CurrentInstance.Cache[cacheKey];
        ...
        private static string RetrieveLocalCss(string file, string cacheKey)
        {
            ...
            try
            {
               ...
               css = ProcessCss(css);
                Applications.CurrentInstance.Cache.Insert(cacheKey, css, new CacheDependency(path));
